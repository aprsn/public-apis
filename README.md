...
API | Description | Auth | HTTPS | CORS |
|---|---|---|---|---|
| [Finage](https://finage.co.uk) | Finage is a stock, currency, cryptocurrency, indices, ETFs and fundamental real-time & historical data provider company.  | `apiKey` | Yes | Unknown |
